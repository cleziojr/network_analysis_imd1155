...
class Rede:
    ...
    def exibe_rede(self, g: nx.DiGraph, cabecalho: str, nome_arquivo_rede: str) -> None:
        ...
        rede = net.Network(bgcolor='white', font_color='black', height='800px', width='100%', heading=cabecalho, directed=True, neighborhood_highlight=True, select_menu=True, filter_menu=True, notebook=True, cdn_resources='remote')
        rede.from_nx(g)
