...
class Rede:
    ...
    def exibe_rede(self, g: nx.DiGraph, cabecalho: str, nome_arquivo_rede: str) -> None:
        ...
        rede = net.Network(bgcolor='#ffffff', font_color='black', height='700px', width='80%', heading=cabecalho, directed=True, neighborhood_highlight=True, select_menu=True, filter_menu=True, notebook=True, cdn_resources='remote')
        rede.from_nx(g)
    ...
    def exibe_distribuicao_grau(self) -> None:
        ...
        fig, ax = plt.subplots()
        plt.bar(deg, cnt, height=0.70, width=0.70, color='b')
